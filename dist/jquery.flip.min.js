...
!function(a){var b=function(a,b,c){a.data("fliped",!0),a.css({transform:b}),setTimeout(c.callback,c.speed)},c=function(a){a.data("fliped",!1),a.css({transform:"rotatex(0deg)"})};a.fn.flip=function(d){return this.each(function(){var e=a(this);if(void 0!==d&&"boolean"==typeof d)d?b(e,e.data("flipedRotate")):c(e);else{var f,g=a.extend({axis:"y",reverse:!1,trigger:"click",speed:500,callback:function(){}},d),h=g.reverse?"-180deg":"180deg";"x"==g.axis.toLowerCase()?(f=2*e.outerHeight(),e.data("flipedRotate","rotatex("+h+")")):(f=2*e.outerWidth(),e.data("flipedRotate","rotatey("+h+")"));var i=e.data("flipedRotate");e.wrap("<div class='flip'></div>"),e.parent().css({perspective:f,position:"relative","margin-top":e.css("margin-top"),"margin-bottom":e.css("margin-bottom"),"margin-left":e.css("margin-left"),"margin-right":e.css("margin-right"),width:e.outerWidth(),height:e.outerHeight()});var j=g.speed/1e3||.5;if(e.css({"transform-style":"preserve-3d",transition:"all "+j+"s ease-out",margin:"0px"}),e.find(".front, .back").outerHeight(e.height()),e.find(".front, .back").outerWidth(e.width()),e.find(".front, .back").css({position:"absolute","backface-visibility":"hidden"}),e.find(".back").css({transform:i}),"click"==g.trigger.toLowerCase())e.find('button, a, input[type="submit"]').click(function(a){a.stopPropagation()}),e.click(function(){e.data("fliped")?c(e):b(e,i,g)});else if("hover"==g.trigger.toLowerCase()){var k=function(){e.unbind("mouseleave",l),b(e,i,g),setTimeout(function(){e.bind("mouseleave",l),e.is(":hover")||c(e)},g.speed+150)},l=function(){c(e)};e.mouseenter(k),e.mouseleave(l)}}}),this}}(jQuery);